...
class Database(SmartPlugin):
    ...
    def _series(self, func, start, end='now', count=100, ratio=1, update=False, step=None, sid=None, item=None):
        ...
        :param start:
        :param end:
        :param count: Integer number of data samples requested
        :param ratio:
        :param update:
        :param step:
        :param sid:
        ...
        if debug_output:
            self.logger.warning(f"DEBUG 1a _series: logs['istart'] {logs['istart']}, logs['iend'], logs['step'] {logs['step']}, logs['count'] {logs['count']}")
